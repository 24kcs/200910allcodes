              ...
              <div class="couponWrap" v-if="couponInfoList.length > 0">
                ...
                <div class="fl fix-width">
                  <div class="fl fix-width">
                    <a
                      href="javascript:;"
                      :title="couponIn.couponName"
                      v-for="(couponIn, index) in couponInfoList"
                      :key="couponIn.id"
                    >
                      <i
                        class="red-bg i-coupon"
                        v-if="couponIn.couponType === 'CASH'"
                        >现金卷{{ couponIn.benefitAmount }}元</i
                      >

                      <i
                        class="red-bg i-coupon"
                        v-else-if="couponIn.couponType === 'FULL_REDUCTION'"
                        >满{{ couponIn.conditionAmount }}减{{
                          couponIn.benefitAmount
                        }}元</i
                      >

                      <i
                        class="red-bg i-coupon"
                        v-else-if="couponIn.couponType === 'FULL_DISCOUNT'"
                        >满{{ couponIn.conditionNum }}件打{{
                          couponIn.benefitDiscount
                        }}折</i
                      >

                      <i
                        class="red-bg i-coupon"
                        v-else-if="couponIn.couponType === 'DISCOUNT'"
                        >折扣卷{{ couponIn.benefitDiscount }}折</i
                      >
                    </a>
                  </div>
                </div>
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(attr,index) in spuSaleAttrList" :key="attr.id">
                ...
                <dd changepirce="0" :class="{active:val.isChecked==='1'}" v-for="val in attr.spuSaleAttrValueList" :key="val.id">
                  ...
                  >
                    <ul style="overflow: auto">
                      ...
                      >
                        ...
                        <p class="coupon-time">过期时间：2021-10-22 00:00:00</p>
